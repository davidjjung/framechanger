...
public class FCBlocks {
    ...
    public static final RegistryObject<Block> CRYING_OBSIDIAN_BRICKS = HELPER.createBlock("crying_obsidian_bricks", () -> new CryingObsidianBlock(BlockBehaviour.Properties.of(Material.STONE).requiresCorrectToolForDrops().strength(22.5F, 600.0F).lightLevel((p_152651_) -> {return 10;})), CreativeModeTab.TAB_BUILDING_BLOCKS);
    public static final RegistryObject<Block> CRYING_OBSIDIAN_BRICK_SLAB = HELPER.createBlock("crying_obsidian_brick_slab", () -> new CryingSlabBlock(BlockBehaviour.Properties.of(Material.STONE).requiresCorrectToolForDrops().strength(22.5F, 600.0F).lightLevel((p_152651_) -> {return 10;})), CreativeModeTab.TAB_BUILDING_BLOCKS);
    ...
    public static final RegistryObject<Block> CRYING_OBSIDIAN_BRICK_WALL = HELPER.createBlock("crying_obsidian_brick_wall", () -> new CryingWallBlock(BlockBehaviour.Properties.of(Material.STONE).requiresCorrectToolForDrops().strength(22.5F, 600.0F).lightLevel((p_152651_) -> {return 10;})), CreativeModeTab.TAB_BUILDING_BLOCKS);
    ...
    public static final RegistryObject<Block> CRYING_POLISHED_OBSIDIAN = HELPER.createBlock("crying_polished_obsidian", () -> new CryingObsidianBlock(BlockBehaviour.Properties.of(Material.STONE).requiresCorrectToolForDrops().strength(22.5F, 600.0F).lightLevel((p_152651_) -> {return 10;})), CreativeModeTab.TAB_BUILDING_BLOCKS);
    public static final RegistryObject<Block> CRYING_POLISHED_OBSIDIAN_SLAB = HELPER.createBlock("crying_polished_obsidian_slab", () -> new CryingSlabBlock(BlockBehaviour.Properties.of(Material.STONE).requiresCorrectToolForDrops().strength(22.5F, 600.0F).lightLevel((p_152651_) -> {return 10;})), CreativeModeTab.TAB_BUILDING_BLOCKS);
    ...
    public static final RegistryObject<Block> CRYING_POLISHED_OBSIDIAN_WALL = HELPER.createBlock("crying_polished_obsidian_wall", () -> new CryingWallBlock(BlockBehaviour.Properties.of(Material.STONE).requiresCorrectToolForDrops().strength(22.5F, 600.0F).lightLevel((p_152651_) -> {return 10;})), CreativeModeTab.TAB_BUILDING_BLOCKS);
    ...
    public static final RegistryObject<Block> CRYING_OBSIDIAN_PILLAR = HELPER.createBlock("crying_obsidian_pillar", () -> new CryingRotatedPillarBlock(BlockBehaviour.Properties.of(Material.STONE).requiresCorrectToolForDrops().strength(22.5F, 600.0F).lightLevel((p_152651_) -> {return 10;})), CreativeModeTab.TAB_BUILDING_BLOCKS);
    ...
    public static final RegistryObject<Block> CRYING_CHISELED_OBSIDIAN = HELPER.createBlock("crying_chiseled_obsidian", () -> new CryingObsidianBlock(BlockBehaviour.Properties.of(Material.STONE).requiresCorrectToolForDrops().strength(22.5F, 600.0F).lightLevel((p_152651_) -> {return 10;})), CreativeModeTab.TAB_BUILDING_BLOCKS);
